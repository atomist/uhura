...
export class DotnetCoreInterpreter implements Interpreter {
    ...
    private readonly versionGoal: Version = new Version().withVersioner(DotnetCoreProjectVersioner);
 ...
 */
export const dotnetCoreVersionGrammar = Microgrammar.fromString<{ version: string }>(
